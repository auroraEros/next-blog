      ...
      <div className="max-w-2xl mx-auto p-3 text-center">
        <div>
          ...
          <div className="text-md text-gray-500 flex flex-col gap-6">
            <p>
              Welcome to Sahar&apos;s Blog! Created by Sahar Javadi, this blog
              serves as a personal platform to share her insights and ideas with
              the world. Sahar is a dedicated front-end developer who enjoys
              building clean, user-friendly interfaces and occasionally writes
              about technology, coding, and digital experiences.
            </p>
